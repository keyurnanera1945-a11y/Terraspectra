...
OUTPUT_DIR = "outputs/evaluation_augmented"
...
def main():
    ...
    print("=" * 70)
    print("TerraSpectra - Augmented 3D CNN Evaluation")
    print("=" * 70)
    ...
    with open(
        ...
        f.write(
            "TerraSpectra - Augmented 3D CNN Evaluation\n"
        )
    ...
    plt.title(
        "Augmented 3D CNN Confusion Matrix"
    )
